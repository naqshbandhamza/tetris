...
horizontal_piece::horizontal_piece(game* ptr,std::string type)
{
	this->ptr = ptr;
	this->type = type;
}

void horizontal_piece::create()
{
	char arr[7] = { 'r','y','g','b','p','o','P' };//p for purple and P for pink
	srand(time(NULL));
	int v2 = rand() % 7;
	this->color = arr[v2];
	this->pos_p1_r = this->pos_p2_r = this->pos_p3_r = this->pos_p4_r = 0;
	srand(time(NULL));
	this->pos_p1_c = rand() % 10;
	while (this->pos_p1_c + 3 >= 10)
	{
		this->pos_p1_c = rand() % 10;
	}
...
void horizontal_piece::update_pos(int p1_r, int p1_c, int p2_r, int p2_c, int p3_r, int p3_c, int p4_r, int p4_c)
{
...
horizontal_piece::~horizontal_piece()
{
