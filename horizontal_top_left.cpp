...
horizontal_top_left::horizontal_top_left(game* ptr, std::string type)
{
	this->ptr = ptr;
	this->type = type;
}

void horizontal_top_left::create()
{
	...
	int top_choice = rand() % 3;
	cout << "top choice:" << top_choice << endl;


	this->pos_p1_r = 0;
	this->pos_p2_r = this->pos_p3_r = this->pos_p4_r= this->pos_p1_r+1;
	srand(time(NULL));
	this->pos_p2_c = rand() % 10;
	while (this->pos_p2_c + 2 >= 10)
	{
		this->pos_p2_c = rand() % 10;
	}
	...
	if (top_choice == 0)
	{
		this->pos_p1_c = this->pos_p2_c;
		this->pos_p3_c = this->pos_p2_c + 1;
		this->pos_p4_c = this->pos_p3_c + 1;
	}
	else if (top_choice == 1)
	{
		this->pos_p3_c = this->pos_p2_c + 1;
		this->pos_p1_c = this->pos_p3_c;
		this->pos_p4_c = this->pos_p3_c + 1;
	}
...
void horizontal_top_left::update_pos(int p1_r, int p1_c, int p2_r, int p2_c, int p3_r, int p3_c, int p4_r, int p4_c)
{
...
horizontal_top_left::~horizontal_top_left()
{
	cout << "horizontal_top_left destructor called" << endl;
}